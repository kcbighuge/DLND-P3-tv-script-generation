# Deep Learning Nanodegree Foundation: Simpsons TV script generation

This repository contains material for one of the projects in Udacity's [Deep Learning Nanodegree Foundation](https://www.udacity.com/course/deep-learning-nanodegree-foundation--nd101) program. 

You can find the full list of materials outlined below, or visit the main repo [here](https://github.com/udacity/deep-learning).
